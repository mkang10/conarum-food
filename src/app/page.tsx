...
export default function WaitingPage() {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      const isLoggedIn = localStorage.getItem("hehe");
      if (isLoggedIn) {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-[var(--color-primary)] text-center animate-fadeIn">
